...
question = "Bạn hãy đóng vai trò như một Tarot Reader. Giả sử tôi có 3 lá bài Tarot là Chariot (Upright), Wheel of Fortune (Reverse), The Magician (Reverse). Hãy bói toán cho tôi biết tương lai của tôi như thế nào? Trả lời với lời văn ma mị"
start = time.time()
